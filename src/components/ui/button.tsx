...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-cardinal text-white shadow-sm hover:bg-cardinal-hover hover:shadow-md",
        destructive:
          "bg-red-500 text-white shadow-sm hover:bg-red-600",
        outline:
          "border border-border bg-transparent shadow-sm hover:bg-muted hover:border-muted-foreground/20",
        secondary:
          "bg-gold text-foreground shadow-sm hover:bg-gold-hover",
        ghost:
          "hover:bg-muted hover:text-foreground",
        link:
          "text-cardinal underline-offset-4 hover:underline",
      },
      size: {
